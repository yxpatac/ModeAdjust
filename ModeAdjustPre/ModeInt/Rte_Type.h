...
SRSMode_IntimacyR,
SRSMode_EzeEntry4s2L,
SRSMode_EzeExt4s2L,
SRSMode_EzeEntry4s2R,
SRSMode_EzeExt4s2R,
SRSMode_EzeEntryAll4sBwd,
SRSMode_EzeEntryAll4sFwd
}SRSCurMode1;
...
typedef enum{
   ...
   SRSSlctSwStat_EzeEntry4s2L,
   SRSSlctSwStat_EzeExt4s2L,
   SRSSlctSwStat_EzeEntry4s2R,
   SRSSlctSwStat_EzeExt4s2R,
   SRSSlctSwStat_EzeEntryAll4sBwd,
   SRSSlctSwStat_EzeEntryAll4sFwd
}SRSMode1;
...
typedef enum{
    ...
    SetReq_RESERVED6,
    SetReq_RESERVED7
}AcsMdEtryStCstChgSetReq1;


typedef enum{
    SetVal_SETTING_UNKNOWN,
    SetVal_OFF,
    SetVal_ON,
    SetVal_RESERVED1,
    SetVal_RESERVED2,
...
typedef enum{
    DoorLckStTyp_unknown,
    DoorLckStTyp_Locked,
    DoorLckStTyp_unlocked,
    DoorLckStTyp_Reserved
}DoorLckSt1;


typedef enum{
    ActvFunc_NoAct,
    ActvFunc_PwrDorLckSw,
    ActvFunc_DrvKeyCyl,
    ActvFunc_RCSwitch,
    ActvFunc_Emergency,
    ActvFunc_ActvRmtKeyfob,
    ActvFunc_PasvRmtKeyfob,
    ActvFunc_EnhancedService,
    ActvFunc_DelyLocking,
    ActvFunc_Relocking,
    ActvFunc_LockOutPrevent,
    ActvFunc_ExteriorLockSw,
    ActvFunc_VKMdev,
    ActvFunc_ADL,
    ActvFunc_Lckstupwlck,
    ActvFunc_PasKeyCyl
}LckUlckActvtFunc1;
